...
router.get('/login/vk', userController.VKID)
...
router.patch('/activate_email', checkRole('ADMIN'), userController.setEmailActivated)
router.post('/self', authMiddleware, userController.getSelf)
router.post('/logout', authMiddleware, userController.logout)
router.get('/activate/:link', userController.activate)
router.post('/activate', userController.resendActivationLink)
